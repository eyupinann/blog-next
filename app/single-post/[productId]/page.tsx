...
const SinglePost = (props: { params: { productId: string; }; }) => {
    const router = useRouter();
    const [blogData, setBlogData] = useState<BlogData | null>(null);

    useEffect(() => {
        const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NTAzMTE4ODZkYWQ5OGNmZjZhMDgyZTkiLCJpYXQiOjE3MDI0OTg0Njh9.kHCR-gScHc7_hSyypCFcdG654CE3Xj_2xcwU4KvjGcI';
        api.get('/blogs/' + props.params.productId, {
            headers: {
                    ...
                    <div className="font-serif">
                        ...
                        <div className="mt-8">
                            <img
                                ...
                                alt={`blog_image`}
                                className={`rounded-xl`}
                                src="https://picsum.photos/800/462"
                            />
                        </div>
